        ...
        Flickable {
            ...
            Column {
                ...
                SettingsRow {
                    ...
                    fontScale: settingsRoot.fontScaleValue
                    palette: settingsRoot.palette
                    label: settingsRoot.tr("titleMarquee")
                    valueText: settingsRoot.titleMarqueeValue ? settingsRoot.tr("titleMarqueeOn") : settingsRoot.tr("titleMarqueeOff")
                }

                SettingsRow {
                    id: rowCollectionMarquee
                    width: parent.width
                    height: panel.rowHeight
                    panelWidth: panel.width
                    ...
                    fontScale: settingsRoot.fontScaleValue
                    palette: settingsRoot.palette
                    label: settingsRoot.tr("collectionMarquee")
                    valueText: settingsRoot.collectionMarqueeValue ? settingsRoot.tr("collectionMarqueeOn") : settingsRoot.tr("collectionMarqueeOff")
                }
